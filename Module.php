...
class Module extends \yii\base\Module
{
     ...
     * Its used when `layout` set to 'left-menu', 'right-menu' or 'top-menu'.
     */
    public $mainLayout = '@imanilchaudhari/mongodb/admin/views/layouts/main.php';
    /**
     * @var array
     * @see [[menus]]
     */
    ...
    public function init()
    {
        ...
        if (class_exists('yii\jui\JuiAsset')) {
            Yii::$container->set('imanilchaudhari\mongodb\admin\AutocompleteAsset', 'yii\jui\JuiAsset');
        }
    }
