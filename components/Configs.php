 ...
 *
 * ```
 * Yii::$container->set('imanilchaudhari\mongodb\admin\components\Configs',[
 *     'db' => 'customDb',
 *     'menuCollection' => 'admin_menu',
 * ]);
 * ```
...
class Configs extends \imanilchaudhari\mongodb\admin\BaseObject
{
    ...
    /**
     * @var string Menu collection name.
     */
    public $menuCollection = 'admin_menu';
     ...
     * @return string
     */
    public static function menuCollection()
    {
        return static::instance()->menuCollection;
    }
