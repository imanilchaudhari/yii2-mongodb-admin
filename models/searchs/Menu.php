...
use imanilchaudhari\mongodb\admin\models\Menu as MenuModel;
use yii\base\Model;
use yii\data\ActiveDataProvider;

/**
 * Menu represents the model behind the search form about [[\imanilchaudhari\mongodb\admin\models\Menu]].
 * 
...
class Menu extends MenuModel
{
    ...
    public function search($params)
    {
        $query = MenuModel::find()
            ->from(Configs::instance()->menuCollection . ' t')
            ->joinWith(['menuParent' => function ($q) {
            $q->from(Configs::instance()->menuCollection . ' parent');
        }]);
